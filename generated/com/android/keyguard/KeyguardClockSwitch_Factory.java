...
public final class KeyguardClockSwitch_Factory implements Factory<KeyguardClockSwitch> {
  ...
  public KeyguardClockSwitch_Factory(
  ...
  public KeyguardClockSwitch get() {
    return provideInstance(
        ...
        clockManagerProvider);
  }

  public static KeyguardClockSwitch provideInstance(
      Provider<Context> contextProvider,
      Provider<AttributeSet> attrsProvider,
      Provider<StatusBarStateController> statusBarStateControllerProvider,
      Provider<SysuiColorExtractor> colorExtractorProvider,
    ...
    return new KeyguardClockSwitch(
        ...
        colorExtractorProvider.get(),
        clockManagerProvider.get());
  }

  public static KeyguardClockSwitch_Factory create(
      Provider<Context> contextProvider,
      Provider<AttributeSet> attrsProvider,
      Provider<StatusBarStateController> statusBarStateControllerProvider,
      Provider<SysuiColorExtractor> colorExtractorProvider,
      Provider<ClockManager> clockManagerProvider) {
    return new KeyguardClockSwitch_Factory(
        contextProvider,
        attrsProvider,
        statusBarStateControllerProvider,
        colorExtractorProvider,
  ...
  public static KeyguardClockSwitch newKeyguardClockSwitch(
      Context context,
      AttributeSet attrs,
    ...
    return new KeyguardClockSwitch(
        context, attrs, statusBarStateController, colorExtractor, clockManager);
  }
}
