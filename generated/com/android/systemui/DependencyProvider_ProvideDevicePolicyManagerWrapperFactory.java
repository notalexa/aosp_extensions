...
public final class DependencyProvider_ProvideDevicePolicyManagerWrapperFactory
    implements Factory<DevicePolicyManagerWrapper> {
  ...
  public static DevicePolicyManagerWrapper proxyProvideDevicePolicyManagerWrapper(
      DependencyProvider instance) {
    return Preconditions.checkNotNull(
        instance.provideDevicePolicyManagerWrapper(),
