...
public final class CastTile_Factory implements Factory<CastTile> {
  ...
  public static CastTile provideInstance(
      Provider<QSHost> hostProvider,
      Provider<CastController> castControllerProvider,
      Provider<KeyguardMonitor> keyguardMonitorProvider,
      Provider<NetworkController> networkControllerProvider,
  ...
  public static CastTile_Factory create(
      Provider<QSHost> hostProvider,
      Provider<CastController> castControllerProvider,
      Provider<KeyguardMonitor> keyguardMonitorProvider,
      Provider<NetworkController> networkControllerProvider,
      Provider<ActivityStarter> activityStarterProvider) {
    return new CastTile_Factory(
        hostProvider,
        castControllerProvider,
        keyguardMonitorProvider,
        networkControllerProvider,
  ...
  public static CastTile newCastTile(
      QSHost host,
