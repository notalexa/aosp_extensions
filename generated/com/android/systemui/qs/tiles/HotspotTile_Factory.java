...
public final class HotspotTile_Factory implements Factory<HotspotTile> {
  ...
  public HotspotTile get() {
    return provideInstance(hostProvider, hotspotControllerProvider, dataSaverControllerProvider);
  }

  public static HotspotTile provideInstance(
      Provider<QSHost> hostProvider,
      Provider<HotspotController> hotspotControllerProvider,
      Provider<DataSaverController> dataSaverControllerProvider) {
    return new HotspotTile(
        hostProvider.get(), hotspotControllerProvider.get(), dataSaverControllerProvider.get());
  }

  public static HotspotTile_Factory create(
      Provider<QSHost> hostProvider,
      Provider<HotspotController> hotspotControllerProvider,
      Provider<DataSaverController> dataSaverControllerProvider) {
    return new HotspotTile_Factory(
        hostProvider, hotspotControllerProvider, dataSaverControllerProvider);
  }

  public static HotspotTile newHotspotTile(
      QSHost host, HotspotController hotspotController, DataSaverController dataSaverController) {
