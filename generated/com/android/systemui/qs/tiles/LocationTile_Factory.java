...
public final class LocationTile_Factory implements Factory<LocationTile> {
  ...
  public LocationTile get() {
    return provideInstance(
        hostProvider, locationControllerProvider, keyguardMonitorProvider, activityStarterProvider);
  }

  public static LocationTile provideInstance(
      Provider<QSHost> hostProvider,
      Provider<LocationController> locationControllerProvider,
      Provider<KeyguardMonitor> keyguardMonitorProvider,
      Provider<ActivityStarter> activityStarterProvider) {
    return new LocationTile(
        hostProvider.get(),
        locationControllerProvider.get(),
        keyguardMonitorProvider.get(),
        activityStarterProvider.get());
  }

  public static LocationTile_Factory create(
      Provider<QSHost> hostProvider,
      Provider<LocationController> locationControllerProvider,
      Provider<KeyguardMonitor> keyguardMonitorProvider,
      Provider<ActivityStarter> activityStarterProvider) {
    return new LocationTile_Factory(
        hostProvider, locationControllerProvider, keyguardMonitorProvider, activityStarterProvider);
  }

  public static LocationTile newLocationTile(
      QSHost host,
