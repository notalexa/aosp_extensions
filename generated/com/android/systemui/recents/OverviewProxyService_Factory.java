...
public final class OverviewProxyService_Factory implements Factory<OverviewProxyService> {
  ...
  public OverviewProxyService_Factory(
      ...
      Provider<DeviceProvisionedController> provisionControllerProvider,
      Provider<NavigationBarController> navBarControllerProvider,
  ...
  public OverviewProxyService get() {
    return provideInstance(
        contextProvider,
        provisionControllerProvider,
        navBarControllerProvider,
        navModeControllerProvider,
        statusBarWinControllerProvider);
  }

  public static OverviewProxyService provideInstance(
      Provider<Context> contextProvider,
      Provider<DeviceProvisionedController> provisionControllerProvider,
      Provider<NavigationBarController> navBarControllerProvider,
      Provider<NavigationModeController> navModeControllerProvider,
      Provider<StatusBarWindowController> statusBarWinControllerProvider) {
    return new OverviewProxyService(
        contextProvider.get(),
        provisionControllerProvider.get(),
        navBarControllerProvider.get(),
        navModeControllerProvider.get(),
        statusBarWinControllerProvider.get());
  }

  public static OverviewProxyService_Factory create(
      Provider<Context> contextProvider,
      Provider<DeviceProvisionedController> provisionControllerProvider,
      Provider<NavigationBarController> navBarControllerProvider,
      Provider<NavigationModeController> navModeControllerProvider,
      Provider<StatusBarWindowController> statusBarWinControllerProvider) {
    return new OverviewProxyService_Factory(
        contextProvider,
        provisionControllerProvider,
        navBarControllerProvider,
        navModeControllerProvider,
  ...
  public static OverviewProxyService newOverviewProxyService(
      Context context,
    ...
    return new OverviewProxyService(
        context, provisionController, navBarController, navModeController, statusBarWinController);
  }
}
