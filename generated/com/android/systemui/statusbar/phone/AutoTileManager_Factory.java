...
public final class AutoTileManager_Factory implements Factory<AutoTileManager> {
  ...
  public AutoTileManager_Factory(
      Provider<Context> contextProvider,
      Provider<AutoAddTracker> autoAddTrackerProvider,
      Provider<QSTileHost> hostProvider,
  ...
  public AutoTileManager get() {
    return provideInstance(
        ...
        nightDisplayListenerProvider,
        castControllerProvider);
  }

  public static AutoTileManager provideInstance(
      Provider<Context> contextProvider,
      Provider<AutoAddTracker> autoAddTrackerProvider,
      Provider<QSTileHost> hostProvider,
      Provider<Handler> handlerProvider,
      ...
      Provider<NightDisplayListener> nightDisplayListenerProvider,
      Provider<CastController> castControllerProvider) {
    return new AutoTileManager(
        contextProvider.get(),
        autoAddTrackerProvider.get(),
        hostProvider.get(),
        handlerProvider.get(),
        hotspotControllerProvider.get(),
        dataSaverControllerProvider.get(),
        managedProfileControllerProvider.get(),
        nightDisplayListenerProvider.get(),
        castControllerProvider.get());
  }

  public static AutoTileManager_Factory create(
      Provider<Context> contextProvider,
      Provider<AutoAddTracker> autoAddTrackerProvider,
      Provider<QSTileHost> hostProvider,
      Provider<Handler> handlerProvider,
      ...
      Provider<NightDisplayListener> nightDisplayListenerProvider,
      Provider<CastController> castControllerProvider) {
    return new AutoTileManager_Factory(
        contextProvider,
        autoAddTrackerProvider,
        hostProvider,
        handlerProvider,
