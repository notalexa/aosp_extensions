...
public final class NavigationBarFragment_Factory implements Factory<NavigationBarFragment> {
  ...
  public NavigationBarFragment_Factory(
  ...
  public static NavigationBarFragment provideInstance(
      Provider<AccessibilityManagerWrapper> accessibilityManagerWrapperProvider,
      Provider<DeviceProvisionedController> deviceProvisionedControllerProvider,
      Provider<MetricsLogger> metricsLoggerProvider,
      Provider<AssistManager> assistManagerProvider,
    ...
    return new NavigationBarFragment(
        accessibilityManagerWrapperProvider.get(),
        deviceProvisionedControllerProvider.get(),
        metricsLoggerProvider.get(),
        assistManagerProvider.get(),
        overviewProxyServiceProvider.get(),
        navigationModeControllerProvider.get(),
        statusBarStateControllerProvider.get());
  }

  public static NavigationBarFragment_Factory create(
      Provider<AccessibilityManagerWrapper> accessibilityManagerWrapperProvider,
      Provider<DeviceProvisionedController> deviceProvisionedControllerProvider,
      Provider<MetricsLogger> metricsLoggerProvider,
      Provider<AssistManager> assistManagerProvider,
      ...
      Provider<NavigationModeController> navigationModeControllerProvider,
      Provider<StatusBarStateController> statusBarStateControllerProvider) {
    return new NavigationBarFragment_Factory(
        accessibilityManagerWrapperProvider,
        deviceProvisionedControllerProvider,
        metricsLoggerProvider,
        assistManagerProvider,
  ...
  public static NavigationBarFragment newNavigationBarFragment(
