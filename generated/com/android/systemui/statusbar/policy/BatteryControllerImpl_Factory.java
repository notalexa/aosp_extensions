...
public final class BatteryControllerImpl_Factory implements Factory<BatteryControllerImpl> {
  ...
  public BatteryControllerImpl_Factory(
  ...
  public BatteryControllerImpl get() {
    return provideInstance(contextProvider, enhancedEstimatesProvider);
  }

  public static BatteryControllerImpl provideInstance(
      Provider<Context> contextProvider, Provider<EnhancedEstimates> enhancedEstimatesProvider) {
    return new BatteryControllerImpl(contextProvider.get(), enhancedEstimatesProvider.get());
  }

  public static BatteryControllerImpl_Factory create(
      Provider<Context> contextProvider, Provider<EnhancedEstimates> enhancedEstimatesProvider) {
    return new BatteryControllerImpl_Factory(contextProvider, enhancedEstimatesProvider);
  }

  public static BatteryControllerImpl newBatteryControllerImpl(
