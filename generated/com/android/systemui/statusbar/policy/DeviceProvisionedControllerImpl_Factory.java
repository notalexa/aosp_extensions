...
public final class DeviceProvisionedControllerImpl_Factory
    implements Factory<DeviceProvisionedControllerImpl> {
  private final Provider<Context> contextProvider;

  private final Provider<Handler> mainHandlerProvider;

  public DeviceProvisionedControllerImpl_Factory(
  ...
  public static DeviceProvisionedControllerImpl provideInstance(
      Provider<Context> contextProvider, Provider<Handler> mainHandlerProvider) {
  ...
  public static DeviceProvisionedControllerImpl newDeviceProvisionedControllerImpl(
