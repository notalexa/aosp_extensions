...
interface ITrustManager {
    AuthSet granted(int userId);
	Intent nextChallenge(int userId);
    void revokeAll();
	void grant(int userId,in AuthSet factors);
	boolean isGranted(int userId,in AuthSet factors);
    ...
    // Reflect reportDeviceLockedForUser
