...
public abstract class PackageManager {
    ...
    /**
     * Feature for {@link #getSystemAvailableFeatures} and {@link #hasSystemFeature}:
     * The device accepts escrow tokens for synthetic passwords.
     * <br>This feature should be enabled for automotive builds.
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ACCEPT_ESCROW_TOKENS = "android.security.accept_escrow_tokens";
