...
public interface KeyguardSecurityCallback {
    ...
    /**
     * Dismiss the given security screen of authentication type {@link AuthType#Secret}.
     * 
    ...
    default void dismiss(boolean securityVerified, int targetUserId) {
        dismiss(AuthType.Secret,securityVerified,targetUserId);
    }
    
    /**
     * Dismiss the given security screen.
     * @param type the type of the security screen  
     * @param securityVerified true if the user correctly entered credentials for the given screen.
     * @param targetUserId a user that needs to be the foreground user at the dismissal completion.
     */
    void dismiss(AuthType type, boolean securityVerified, int targetUserId);
    ...
    /**
     * Call to report an unlock attempt of type {@link AuthType#Secret}.
     * 
    ...
    /**
     * Call to report an unlock attempt of the given type.
     * @param userId id of the user whose unlock attempt is recorded.
     * @param type the authentication type of the unlock attempt.
     * @param success set to 'true' if user correctly entered security credentials.
     * @param timeoutMs timeout in milliseconds to wait before reattempting an unlock.
     *                  Only nonzero if 'success' is false
     */    
    void reportUnlockAttempt(int userId, AuthType type, boolean success, int timeoutMs);
