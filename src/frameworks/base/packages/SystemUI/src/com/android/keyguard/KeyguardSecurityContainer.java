...
public class KeyguardSecurityContainer extends FrameLayout implements KeyguardSecurityView {
    ...
    public interface SecurityCallback {
        public boolean dismiss(AuthType factor, boolean authenticated, int targetUserId);
         ...
         */
        public void finish(AuthType factor, boolean auth, int targetUserId);
    ...
    private void showTimeoutDialog(int userId, int timeoutMs) {
        ...
        switch (mUpdateMonitor.getSecurityMode(userId)) {
            case Pattern:
    ...
    void showPrimarySecurityScreen(boolean turningOff) {
        SecurityMode securityMode = mUpdateMonitor.getSecurityMode(
                KeyguardUpdateMonitor.getCurrentUser());
        if (DEBUG) Log.v(TAG, "showPrimarySecurityScreen(turningOff=" + turningOff + ", "+securityMode+")");
    ...
    boolean showNextSecurityScreenOrFinish(boolean authenticated, int targetUserId) {
        ...
        if (mUpdateMonitor.getUserHasTrust(targetUserId)) {
            ...
            SecurityMode securityMode = mUpdateMonitor.getSecurityMode(targetUserId);
        	...
        	if(DEBUG) Log.i(TAG,"Authenticated. Inform Trust manager of grants");
            switch (mCurrentSecuritySelection) {
                ...
                case SimPuk:
                    ...
                    SecurityMode securityMode = mUpdateMonitor.getSecurityMode(targetUserId);
                    if (securityMode == SecurityMode.None || mUpdateMonitor.isLockScreenDisabled(KeyguardUpdateMonitor.getCurrentUser())) {
                        finish = true;
    ...
    public void finish(int targetUserId) {
    	mSecurityCallback.finish(true, targetUserId);
    }
    ...
    private KeyguardSecurityCallback mCallback = new KeyguardSecurityCallback() {
        ...
        public void dismiss(boolean authenticated, int targetId) {
        	dismiss(AuthType.Secret,authenticated,targetId);
        }
        
        public void dismiss(AuthType factor, boolean authenticated, int targetId) {
        	if(authenticated) {
        		mUpdateMonitor.reportSuccessfulAuthentication(targetId,factor);
        	}
            mSecurityCallback.dismiss(factor, authenticated,targetId);
        }
        ...
        public void reportUnlockAttempt(int userId, boolean success, int timeoutMs) {
        	reportUnlockAttempt(userId, AuthType.Secret,success, timeoutMs);
        }
        
        public void reportUnlockAttempt(int userId, AuthType factor, boolean success, int timeoutMs) {
            if (success) {
    ...
    private KeyguardSecurityCallback mNullCallback = new KeyguardSecurityCallback() {
        ...
        @Override
        public void dismiss(AuthType factor,boolean securityVerified, int targetUserId) { }
        @Override
        public void reset() {}
    };
    ...
    private int getSecurityViewIdForMode(SecurityMode securityMode) {
        switch (securityMode) {
    		case Challenge: return R.id.keyguard_challenge_view;
    ...
    public int getLayoutIdFor(SecurityMode securityMode) {
        switch (securityMode) {
        	case Challenge: return R.layout.keyguard_challenge_view;
    ...
    public SecurityMode getSecurityMode() {
        return mUpdateMonitor.getSecurityMode(KeyguardUpdateMonitor.getCurrentUser());
    }
    ...
    public void dismiss(boolean authenticated, int targetUserId) {
        mCallback.dismiss(AuthType.Secret,authenticated, targetUserId);
    }
