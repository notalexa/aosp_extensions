...
public class KeyguardViewMediator extends SystemUI {
    ...
    KeyguardUpdateMonitorCallback mUpdateCallback = new KeyguardUpdateMonitorCallback() {
        ...
        public void onUserSwitching(int userId) {
            ...
            synchronized (KeyguardViewMediator.this) {
                ...
                if (mUpdateMonitor.isLockScreenDisabled(userId)) {
        ...
        public void onTrustChanged(int userId) {
            if (userId == KeyguardUpdateMonitor.getCurrentUser()) {
                ...
                if(mUpdateMonitor.isLockScreenDisabled(userId)&&mShowing) {
    ...
    ViewMediatorCallback mViewMediatorCallback = new ViewMediatorCallback() {
        ...
        private int decoratePromptReason(int userId,int promptReason) {
            AuthLevel level=mUpdateMonitor.getAuthLevel(userId);
            return level.isStrong()?promptReason:KeyguardSecurityView.PROMPT_REASON_NONE;
        }
        ...
        public int getBouncerPromptReason() {
            ...
            int strongAuth = strongAuthTracker.getStrongAuthForUser(currentUser).getAuthFlags();

            if (any && !strongAuthTracker.hasUserAuthenticatedSinceBoot()) {
                return decoratePromptReason(currentUser,KeyguardSecurityView.PROMPT_REASON_RESTART);
            } else if (any && (strongAuth & STRONG_AUTH_REQUIRED_AFTER_TIMEOUT) != 0) {
                return decoratePromptReason(currentUser,KeyguardSecurityView.PROMPT_REASON_TIMEOUT);
            } else if (any && (strongAuth & STRONG_AUTH_REQUIRED_AFTER_DPM_LOCK_NOW) != 0) {
                return decoratePromptReason(currentUser,KeyguardSecurityView.PROMPT_REASON_DEVICE_ADMIN);
            } else if (trust && (strongAuth & SOME_AUTH_REQUIRED_AFTER_USER_REQUEST) != 0) {
                return decoratePromptReason(currentUser,KeyguardSecurityView.PROMPT_REASON_USER_REQUEST);
            } else if (any && (strongAuth & STRONG_AUTH_REQUIRED_AFTER_LOCKOUT) != 0) {
                return decoratePromptReason(currentUser,KeyguardSecurityView.PROMPT_REASON_AFTER_LOCKOUT);
            }
    ...
    private void setupLocked() {
        ...
        if (mContext.getResources().getBoolean(
            ...
            setShowingLocked(!shouldWaitForProvisioning()
                    && !mUpdateMonitor.isLockScreenDisabled(KeyguardUpdateMonitor.getCurrentUser()),
    ...
    public void onStartedGoingToSleep(int why) {
        ...
        synchronized (this) {
            ...
            mLockPatternUtils.requireStrongAuth(StrongAuthTracker.DEFAULT_AUTH_REQUIRED, currentUser);
    ...
    private void maybeSendUserPresentBroadcast() {
        if (mSystemReady && mUpdateMonitor.isLockScreenDisabled(KeyguardUpdateMonitor.getCurrentUser())) {
    ...
    private void doKeyguardLocked(Bundle options) {
        ...
        if (!mustNotUnlockCurrentUser()
            ...
            if (mUpdateMonitor.isLockScreenDisabled(KeyguardUpdateMonitor.getCurrentUser())
    ...
    private SecurityMode getSecurityMode() {
    	return mStatusBarKeyguardViewManager.getBouncer().getSecurityMode();
    }
