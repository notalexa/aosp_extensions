...
public class BiometricUnlockController extends KeyguardUpdateMonitorCallback {
    ...
    public static final int MODE_UPDATE_VISIBLE_BOUNCER = 33;
    ...
    public void startWakeAndUnlock(int mode) {
        ...
        switch (mMode) {
            case MODE_DISMISS_BOUNCER:
                ...
                break;
            case MODE_UNLOCK:
            case MODE_UPDATE_VISIBLE_BOUNCER:
    ...
    private void showBouncer() {
        switch(mMode) {
            case MODE_SHOW_BOUNCER:mStatusBarKeyguardViewManager.showBouncer(false,false);
                break;
            case MODE_UPDATE_VISIBLE_BOUNCER:
                mStatusBarKeyguardViewManager.showBouncer(true, true);
                break;
        }
    ...
    private int calculateMode(BiometricSourceType biometricSourceType) {
        ...
        if (!mUpdateMonitor.isDeviceInteractive()) {
            ...
            } else if (unlockingAllowed || mUnlockMethodCache.canSkipBouncer()) {
        ...
        if (mStatusBarKeyguardViewManager.isShowing()) {
            if ((mStatusBarKeyguardViewManager.isBouncerShowing()
                ...
                return MODE_UPDATE_VISIBLE_BOUNCER;
            }
        }
        return MODE_NONE;
    }
