...
//            mStatusBar.wakeUpIfDozing(SystemClock.uptimeMillis(), mContainer, "BOUNCER_VISIBLE");
    ...
    private final KeyguardUpdateMonitorCallback mUpdateMonitorCallback =
        ...
        public void onEmergencyCallAction() {
            ...
            if (mOccluded) {
                reset(true,true /* hideBouncerWhenShowing */);
            }
        }
    };
    ...
    public void registerStatusBar(StatusBar statusBar,
        ...
        mBouncer = SystemUIFactory.getInstance().createKeyguardBouncer(mContext,mStatusBar,
    ...
    public void show(Bundle options) {
        ...
        reset(false,true /* hideBouncerWhenShowing */);
     ...
     */
    protected void showBouncerOrKeyguard(boolean scrimMode,boolean hideBouncerWhenShowing) {
        if ((mBouncer.needsFullscreenBouncer() && !mDozing)||(!scrimMode&&mBouncer.getSecurityMode()==SecurityMode.Challenge)) {
    ...
    public void showBouncer(boolean scrimmed) {
        showBouncer(true/*false*/,scrimmed);
    }
    public void showBouncer(boolean resetSecuritySelection,boolean scrimmed) {
        Log.d(TAG,"showBouncer(reset="+resetSecuritySelection+",scrimmed="+scrimmed+", mShowing="+mShowing+", bouncer.isShowing()="+mBouncer.isShowing()+")");
        if (mShowing && (resetSecuritySelection||!mBouncer.isShowing())) {
            mBouncer.show(resetSecuritySelection, scrimmed);
        }
        updateStates();
    }
     ...
     */    
    public void reset(boolean scrimMode,boolean hideBouncerWhenShowing) {
        if (mShowing) {
            if (mOccluded && !mDozing) {
                ...
                showBouncerOrKeyguard(scrimMode,hideBouncerWhenShowing);
            }
    ...
    private void setDozing(boolean dozing) {
        if (mDozing != dozing) {
            ...
            if (dozing || mBouncer.needsFullscreenBouncer() || mOccluded) {
                reset(true,dozing /* hideBouncerWhenShowing */);
            }
            updateStates();
    ...
    public void setOccluded(boolean occluded, boolean animate) {
        ...
        if (!mDozing) {
            ...
            reset(false,isOccluding /* hideBouncerWhenShowing*/);
        }
...
//		return mBouncer==null?mLockPatternUtils.isLockScreenDisabled(userId):mBouncer.isLockScreenDisabled(userId);
//	}
}
