...
public class UnlockMethodCache {
    ...
    private void update(boolean updateAlways) {
        ...
        boolean secure = mKeyguardUpdateMonitor.getAuthLevel(user).isStrong()&&mLockPatternUtils.isSecure(user);
        boolean canSkipBouncer = mKeyguardUpdateMonitor.getUserCanSkipBouncer(user)
