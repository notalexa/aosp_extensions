...
public class LockSettingsService extends ILockSettings.Stub {
    ...
    protected static class SynchronizedStrongAuthTracker
        ...
        @Override
        protected void handleStrongAuthRequiredChanged(AuthLevel level,int strongAuthFlags, int userId) {
            synchronized (this) {
                super.handleStrongAuthRequiredChanged(level,strongAuthFlags, userId);
            }
        }

        @Override
        public LockPatternUtils.StrongAuthFlags getStrongAuthForUser(int userId) {
            synchronized (this) {
    ...
    public void onCleanupUser(int userId) {
        ...
        // the device.
        LockPatternUtils.StrongAuthFlags strongAuthRequired = LockPatternUtils.StrongAuthTracker.getDefaultFlags(mContext);
        requireStrongAuth(strongAuthRequired.getAuthFlags(), userId);
    }
    ...
    private void disableEscrowTokenOnNonManagedDevicesIfNeeded(int userId) {
        ...
        try {
            ...
            if (mContext.getPackageManager().hasSystemFeature(PackageManager.FEATURE_ACCEPT_ESCROW_TOKENS)) {
                Slog.i(TAG, PackageManager.FEATURE_ACCEPT_ESCROW_TOKENS+" enabled.");
                return;
            }
